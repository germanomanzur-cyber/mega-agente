...
// ─── Modo Dueño — prefijo // activa comandos exclusivos de Germán ─────────────
// Solo responde al número 5493424287842. Comandos:
// //tel <nombre> → número de un lead
...
if (!lista.length) return "Sin leads registrados aún.";
return lista.map(l =>
...
body: { text: "Hola, soy Nico 🤖, el asistente de Germán Manzur. ¿Con qué te ayudo hoy? Elegí una opción del menú." },
...
{ id: "opt_vender", title: "Vender o tasar", description: "Tasación orientativa de tu propiedad" },
{ id: "opt_staging", title: "Home Staging IA", description: "Tu propiedad en versión moderna" },
{ id: "opt_docs", title: "Revisar documentación", description: "Contratos y papeles en orden" },
{ id: "opt_german", title: "Hablar con Germán", description: "Te conecto directo con el asesor" },
],
},
],
},
